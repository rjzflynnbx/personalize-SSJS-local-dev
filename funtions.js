...
module.exports = {
    getMostRecentWebSession, getCurrentWebSession, getDataExtensionWithName, getDataExtensionValue, getDataExtensionValue,
    getMapFromDataExtension, getFirstEventOfType, sessionContainsEventOfType, getNumberOfEventsInSession, getTotalNumberOfEvents,
    getAllEventsOfType, getMostRecentAbandonedSession
};
